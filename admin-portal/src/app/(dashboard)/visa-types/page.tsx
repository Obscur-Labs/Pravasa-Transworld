...
import type { Country, VisaType, FormField, DocumentRequirement, FieldType, EntryType, FormPreset, DocumentType, ApplicantType } from '@/types';

const FIELD_TYPES: FieldType[] = ['text', 'number', 'email', 'date', 'select', 'radio', 'textarea', 'file'];
const APPLICANT_OPTS: { value: ApplicantType; label: string; color: string; active: string }[] = [
  { value: 'adult', label: 'Adult', color: 'text-slate-600', active: 'bg-blue-600 text-white' },
  { value: 'both', label: 'Both', color: 'text-slate-600', active: 'bg-violet-600 text-white' },
